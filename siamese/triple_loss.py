...
def get_net(batch_size):
    ...
    loss = fd - fs
    input_shapes = {"same":(1, 1, 299, 299), "diff":(1, 1, 299, 299), "anchor":(1, 1, 299, 299)}
...
if __name__ == '__main__':
    ...
    dot = mx.viz.plot_network(symbol=network, shape={"same":(1, 1, 299, 299), "diff":(1, 1, 299, 299), "anchor":(1, 1, 299, 299), "one": (1, 1)}, node_attrs={"shape":'rect',"fixedsize":'false'})
